...
function main() {
    ...
    const book1 = new Book('Wladcy Much', 'Pawel Skrodz', "Policja 997");
    ...
    // const booked1 = new Booking();
    // console.log(booked1.rentBook(book1, user1));
    // console.log(booked1.returnBook(book1, user1));
    // console.log(booked1)
